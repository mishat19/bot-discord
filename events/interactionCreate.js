                ...
                try{
                    ...
                    for(const value of interaction.values){
                        if(value === 'introduction'){
                            embed.addFields({
                                name: '__But du bot__',
                                value: `${interaction.client.user} est un bot qui souhaite **créer des rencontres** entre personnes afin qu'elles puissent` +
                            ...
                            embed.addFields({
                                ...
                                value: `Dès que tu trouves qu'un profil te correspond et que tu aimerais faire connaissance avec la personne,` +
                                    ...
                                    `⚠️ Vous êtes les seuls à voir les messages du salon, **__le propriétaire garanti ne pas regarder__** les salons de Match (voir ${`<#${'1356023003095502921'}>`}) \n\n`
                            });
                            embed.addFields({
                                name: '__Acceptation__',
                                value: `Cette personne recevra en MP ta demande de contact. Si elle l'accepte, c'est déjà un bon signe, c'est que tu` +
                            ...
                            embed.addFields({
                                name: '__Après l\'acceptation :__',
                                value: `Enfin, tu recevras un message de ma part dans le salon, qui sera épinglé pour le retrouver facilement, avec les boutons :\n\n` +
                                    ` **Match** si tu es satisfait(e) de ta rencontre avec ton Match. Tu obtiendras le magnifique rôle <@&${'1366033894213685343'}> !\n` +
                                    `**Échec** si la personne ne te correspond pas et que tu préfères mettre fin au Match (parles-en lui avant), cela supprimera votre salon.\n` +
                                    `**Signaler** si tu rencontres un problème ou que tu voudrais signaler quelque chose au propriétaire du serveur.`
                            })
